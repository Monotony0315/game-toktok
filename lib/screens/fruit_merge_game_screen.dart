...
/// Fruit Merge Game Screen - Wrapper for Flame game
...
class _FruitMergeGameScreenState extends State<FruitMergeGameScreen> {
              ...
              child: Padding(
                ...
                child: ClipRRect(
                  ...
                  child: GameWidget(
                    game: _game,
                    overlayBuilderMap: {
                      'score': (context, game) => _buildScoreOverlay(game as FruitMergeGame),
                      'gameOver': (context, game) => _buildGameOverOverlay(game as FruitMergeGame),
                    },
                  ),
                ),
              ),
  ...
  Widget _buildScoreOverlay(FruitMergeGame game) {
    return Positioned(
      top: 20,
      right: 20,
      child: Container(
  ...
  Widget _buildGameOverOverlay(FruitMergeGame game) {
    return Container(

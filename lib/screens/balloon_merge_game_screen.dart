...
/// Balloon Merge Game Screen - Wrapper for Flame game
class BalloonMergeGameScreen extends StatefulWidget {
  const BalloonMergeGameScreen({super.key});

  @override
  State<BalloonMergeGameScreen> createState() => _BalloonMergeGameScreenState();
}

class _BalloonMergeGameScreenState extends State<BalloonMergeGameScreen> {
  final AudioManager _audio = AudioManager();
  late BalloonMergeGame _game;

  @override
  void initState() {
    super.initState();
    _game = BalloonMergeGame();
    _playGameMusic();
  }
              ...
              child: Padding(
                ...
                child: ClipRRect(
                  ...
                  child: GameWidget(
                    game: _game,
                    overlayBuilderMap: {
                      'score': (context, game) => _buildScoreOverlay(game as BalloonMergeGame),
                      'gameOver': (context, game) => _buildGameOverOverlay(game as BalloonMergeGame),
                    },
                  ),
                ),
              ),
  ...
  Widget _buildScoreOverlay(BalloonMergeGame game) {
    return Positioned(
      top: 20,
      right: 20,
      child: Container(
  ...
  Widget _buildGameOverOverlay(BalloonMergeGame game) {
    return Container(
